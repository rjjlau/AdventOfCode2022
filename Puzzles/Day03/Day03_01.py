...
CrZsJsPPZsGzwwsLwLmpwMDw"""
    ...
    common_priority_sum(test_input)
    answer_checker = AnswerChecker()
    answer_checker.check(expected_output, common_priority_sum(test_input))

    answer_checker.generate_puzzle_output(__file__, common_priority_sum)
