...
CrZsJsPPZsGzwwsLwLmpwMDw"""
    ...
    answer_checker.check(expected_output, group_priority_sum(test_input))

    answer_checker.generate_puzzle_output(__file__, group_priority_sum)
